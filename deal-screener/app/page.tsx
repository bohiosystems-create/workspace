  ...
  return (
    <div className="shell">
      ...
      <p className="intro">
        ...
        drafts a structured investment-committee memo. Every figure traces to the
        document or the computed model.
      </p>
      ...
      <div className="panel">
        ...
        <div style={{ display: "flex", gap: 12, marginTop: 18, alignItems: "center" }}>
          ...
          <span className="muted">Runs Claude extraction → underwrite → memo. ~20–40s.</span>
        </div>
